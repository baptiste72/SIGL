...
export class AddDeadlinePopupComponent implements OnInit {
  ...
  js_deadline: any;
  type_deadlines: deadlines[] = [{name: 'Rapport de synthèse S5'},{name: 'Rapport de synthèse S6'},{name: 'Rapport de synthèse S7'},{name: 'Rapport de synthèse S8'},{name: 'Rapport de synthèse S9'},{name: 'Rapport Ping'}];

  constructor(public dialogRef: MatDialogRef<AddDeadlinePopupComponent>,
    private deadlineService: DeadlineService,private _snackBar: MatSnackBar,
