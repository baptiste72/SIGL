...
describe('Tests - Coordinateur - CRUD User MA', () => {
    ...
    test("Devrait créer un User avec le rôle MA", async () => {
      ...
      // Centre de Formation dropdown menu
      try {
        await page.waitForSelector('xpath=/html/body/div[2]/div[2]/div/mat-dialog-container/div/div/app-add-user-popup/div[2]/div[2]/mat-form-field/div[1]', TIMEOUT);
        await page.locator('xpath=/html/body/div[2]/div[2]/div/mat-dialog-container/div/div/app-add-user-popup/div[2]/div[2]/mat-form-field/div[1]').click();
        await page.waitForTimeout(1000);
